 ...
 */
public class Participated extends Page {
    public Participated(BrowserInstance browser) throws Exception {
        super(browser);
    ...
    public void openCase(Integer numCase)throws Exception{
        ...
        casesListAction.openCase(numCase, 16);
    }
    ...
    public boolean existCase(Integer numCase)throws Exception{
        ...
        return casesListAction.existCase(numCase, 16);
    }
