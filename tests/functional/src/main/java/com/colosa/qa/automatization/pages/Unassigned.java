 ...
 */
public class Unassigned extends Page {
    public Unassigned(BrowserInstance browser) throws Exception {
        super(browser);
    ...
    public void openCase(Integer numCase)throws Exception{
        ...
        casesListAction.openCase(numCase, 13);
    }
    ...
    public boolean existCase(Integer numCase)throws Exception{
        ...
        return casesListAction.existCase(numCase, 13);
    }
}
